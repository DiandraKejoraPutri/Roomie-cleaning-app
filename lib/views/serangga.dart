...
class Serangga extends StatelessWidget {
  final List<Map<String, String>> services = [
    {'title': 'Tinggi', 'price': 'Rp. 118.000', 'location': 'Sumbawa'},
    {'title': 'Nyamuk', 'price': 'Rp. 118.000', 'location': 'Jakpus'},
    {'title': 'Tikus', 'price': 'Rp. 118.000', 'location': 'Jepang'},
    {'title': 'Lebah', 'price': 'Rp. 118.000', 'location': 'Kamboja'},
  ];
