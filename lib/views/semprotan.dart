...
class Semprotan extends StatelessWidget {
  final List<Map<String, String>> services = [
    {'title': 'Pembersih', 'price': 'Rp. 118.000', 'location': 'Sumbawa'},
    {'title': 'Desinfektan', 'price': 'Rp. 118.000', 'location': 'Jakpus'},
    {'title': 'Serangga', 'price': 'Rp. 118.000', 'location': 'Jepang'},
    {'title': 'Tanaman', 'price': 'Rp. 118.000', 'location': 'Kamboja'},
  ];
