...
class PembersihHarian extends StatelessWidget {
  final List<Map<String, String>> services = [
    {'title': 'Kamar Mandi', 'price': 'Rp. 118.000', 'location': 'Sumbawa'},
    {'title': 'Ruang Tamu', 'price': 'Rp. 118.000', 'location': 'Jakpus'},
    {'title': 'Dapur Umum', 'price': 'Rp. 118.000', 'location': 'Jepang'},
    {'title': 'Teras rumah', 'price': 'Rp. 118.000', 'location': 'Kamboja'},
