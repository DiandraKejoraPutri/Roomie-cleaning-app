...
class Bangunan extends StatelessWidget {
  final List<Map<String, String>> services = [
    {'title': 'Kantor', 'price': 'Rp. 118.000', 'location': 'Sumbawa'},
    {'title': 'Kantor terpadu', 'price': 'Rp. 118.000', 'location': 'Jakpus'},
    {'title': 'Apartment', 'price': 'Rp. 118.000', 'location': 'Jepang'},
    {'title': 'Sekolah', 'price': 'Rp. 118.000', 'location': 'Kamboja'},
    {'title': 'Bangunan Kota', 'price': 'Rp. 507.000', 'location': 'Belanda'},
  ];
