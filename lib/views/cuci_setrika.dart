...
class CuciSetrika extends StatelessWidget {
  final List<Map<String, String>> services = [
    {'title': 'Kaos Ringan', 'price': 'Rp. 118.000', 'location': 'Sumbawa'},
    {'title': 'Satin', 'price': 'Rp. 118.000', 'location': 'Jakpus'},
    {'title': 'Corduray', 'price': 'Rp. 118.000', 'location': 'Jepang'},
    {'title': 'Jumlah Banyak', 'price': 'Rp. 118.000', 'location': 'Kamboja'},
  ];
