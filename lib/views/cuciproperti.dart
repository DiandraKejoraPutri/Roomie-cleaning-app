...
class Cuciproperti extends StatelessWidget {
  final List<Map<String, String>> services = [
    {'title': 'Lemari', 'price': 'Rp. 118.000', 'location': 'Sumbawa'},
    {'title': 'Etalase', 'price': 'Rp. 118.000', 'location': 'Jakpus'},
    {'title': 'Kulkas', 'price': 'Rp. 118.000', 'location': 'Jepang'},
    {'title': 'Meja Belajar', 'price': 'Rp. 118.000', 'location': 'Kamboja'},
  ];
